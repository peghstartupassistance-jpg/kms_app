...
CREATE TABLE IF NOT EXISTS compta_journaux (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (compte_contre_partie) REFERENCES compta_comptes(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 6. MAPPING OPÉRATIONS -> COMPTES (Configuration de génération d'écritures)
CREATE TABLE IF NOT EXISTS compta_mapping_operations (
    ...
    libelle_operation VARCHAR(150),
    base_montant VARCHAR(100),
    ordre_debit INT DEFAULT 1,
    ordre_credit INT DEFAULT 2,
    est_actif TINYINT(1) DEFAULT 1,
    observations TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS compta_operations_trace (
    ...
    statut ENUM('GENEREE', 'VALIDEE', 'REJETEE', 'ANNULEE') DEFAULT 'GENEREE',
    message_erreur TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Données de base : Exercices comptables (exemple 2024 et 2025)
